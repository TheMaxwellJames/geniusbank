...
class WithdrawController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $msg = "Dear " . $name . ", your withdrawal was sucessful";
        $msg2 = "A withdrawal has been made by customer with name: " . $name. " and email: " . $trans->email ;
        ...
        if ($gs->is_smtp) {
            ...
            $loanUserData = [
                'to' => $trans->email,
                'subject' => 'Withdrawal was successful',
                'body' => $msg,
            ];
