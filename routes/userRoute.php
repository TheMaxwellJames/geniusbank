...
use App\Http\Controllers\User\PrintPdfController;
...
Route::prefix('user')->group(function() {
    ...
    Route::group(['middleware' => ['otp','banuser']],function () {
      ...
      Route::group(['middleware'=>'kyc:Transfer'],function(){
        ...
        Route::get(' TransferPdf/{id}', [PrintPdfController::class, 'TransferPdf'])->name('TransferPdf');
    ...
    Route::post('/update/account_type', [UserController::class, 'updateAccountType'])->name('user.update.account_type');
    });


    Route::get('/logout', [UserLoginController::class,'logout'])->name('user.logout');

  // Route::post('/user', [UserController::class,'updateAccountType'])->name('user.update.account_type');
