                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter table-mobile-lg card-table">
                                ...
                                <tr>
                                    ...
                                    <th>{{ __('Amount') }}</th>
                                    <th>{{ __('Status') }}</th>
                                    <th>{{ __('Print Receipt') }}</th>
                                </tr>
                                </thead>
                                <tbody>
                                  @foreach($logs as $key=>$data)
                                      <tr>
                                         <td data-label="{{ __('Date') }}">{{ $data->created_at->toDateTimeString() }}</td>
                                          ...
                                          <td>
                                            <a href="{{ route('TransferPdf', ['id' => $data->id]) }}" class="btn btn-secondary">Print Pdf</a>
                                         </td>
