...
<div class="page-body">
  <div class="container-xl">
    ...
    <div class="row mb-3">
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <div
              class="form-group w-100 d-flex flex-wrap align-items-center justify-content-evenly justify-content-sm-between">
              <h3 class="my-1 text-center text-sm-start">{{ __('You have a information to submit for kyc verification.')
                }}</h3>
              <div class="my-1">
    ...
    <div class="row row-deck row-cards mb-2">
      ...
      <div class="mb-3 mt-3">
        <div class="col-md-12">
          <div class="card">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#accountTypeModal">
              Choose Account Type
            </button>
            <!-- Account Type Modal -->
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="accountTypeModalLabel">form-select Account Type</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    <!-- Account Type Selection Form -->
                    <form method="POST" action="{{ route('user.update.account_type') }}">
                      @csrf
                      <div class="mb-3">
      ...
      <div class="subheader">Account Type:</div>
      <div class="h1 mb-0 mt-2">{{ $user->account_type }}</div>
        ...
        <div class="card mb-2">
          <div class="card-body p-3 p-md-4">
            <div class="balence--item">
              ...
              <div class="content">
                <div class="subheader">{{__('Account Number')}}</div>
                <div class="h1 mb-0 mt-2">@maskAccountNumber($user->account_number)</div>
              </div>
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <div class="input-group input--group">
                <input type="text" name="key" value="{{ url('/').'?reff='.$user->affilate_code}}" class="form-control"
                  id="cronjobURL" readonly>
                <button class="btn btn-sm copytext input-group-text" id="copyBoard" onclick="myFunction()"> <i
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td data-label="@lang('Amount')">
                    <div>
                      <p class="m-0 text-{{ $data->profit == 'plus' ? 'success' : 'danger'}}">{{
                        showNameAmount($data->amount) }}</p>
                    </div>
                  </td>
